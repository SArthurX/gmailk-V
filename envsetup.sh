...
toolchain_dir="${script_dir}/tools/host-tools"
...
toolchain=${toolchain_dir}/gcc/riscv64-linux-musl-x86_64
sys_lib="${script_dir}/lib/system/musl_riscv64"
tdl_lib="${script_dir}/lib/tdl/cv181x_riscv64"
export TOOLCHAIN_PREFIX=${toolchain}/bin/riscv64-unknown-linux-musl-
